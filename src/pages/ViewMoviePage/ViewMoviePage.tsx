  ...
  {movies.map((movie) => (
    <div className="movie-card" key={movie.id}>
      <div className="movie-poster-wrapper">
        ...
        <div className="movie-overlay">
          ...
          <button className="btn-trailer">
            <span role="img" aria-label="play"><PlaySquareOutlined style={{ fontSize: '24px', marginRight: '17px'}} /></span> Trailer
          </button>
        </div>
      ...
      <div className="movie-info">
        ...
        {movie.releaseDate && (
          <div className="movie-release">Khởi chiếu: {movie.releaseDate}</div>
        )}
      </div>
    </div>
  ))}
