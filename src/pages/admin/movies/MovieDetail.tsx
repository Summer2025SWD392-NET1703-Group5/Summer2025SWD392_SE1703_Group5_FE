      ...
      >
        ...
        <div className="flex-grow">
          ...
          <p className="text-gray-400 mt-1">
            {isAdmin ? "Xem thông tin chi tiết của phim" : "Xem thông tin chi tiết của phim (Chế độ chỉ xem)"}
          </p>
          {!isAdmin && (
          ...
          <div className="bg-slate-800 rounded-xl overflow-hidden border border-slate-700 shadow-xl p-4 relative group">
            ...
            <div className="relative poster-glow">
              ...
              {movie.Trailer_Link && (
                ...
                >
                  ...
                  <span className="absolute bottom-6 text-white bg-black bg-opacity-60 px-4 py-1 rounded-full text-sm">
                    Xem trailer
                  </span>
                </a>
              )}
            ...
            <div className="mt-4 space-y-2">
              <div className="flex justify-center">
                <span
                  className={`px-3 py-1 rounded-full text-sm font-medium flex items-center ${statusInfo.className}`}
                >
                  {statusInfo.text}
                </span>
              </div>
              ...
              <div className="text-center text-sm text-gray-400 mt-1">ID: {movie.Movie_ID}</div>
            </div>
          </div>
        </motion.div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                {genres.map((genre: string, index: number) => (
                  <span key={index} className="bg-[#FFD875]/10 text-[#FFD875] px-3 py-1 rounded-full text-sm">
                    {genre.trim()}
                  </span>
                ))}
              </div>
