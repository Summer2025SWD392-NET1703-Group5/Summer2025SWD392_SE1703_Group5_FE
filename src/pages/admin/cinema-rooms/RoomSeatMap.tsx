  ...
  return (
    ...
    >
      ...
      <div className="overflow-auto">
        <div className="seat-grid" style={{ gridTemplateColumns: `auto repeat(${allColumnNumbers.length}, auto)`, gap: '8px' }}>
      ...
      >
        <div>Tổng số ghế: <span className="text-white font-medium">{seatMapData?.stats?.total_seats || (actualRowCount * allColumnNumbers.length - disabledSeats.length)}</span></div>
