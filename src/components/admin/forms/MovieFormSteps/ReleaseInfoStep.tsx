...
const ReleaseInfoStep: React.FC<ReleaseInfoStepProps> = ({ references }) => {
    const { control, watch, setValue, trigger, formState: { errors } } = useFormContext<MovieFormData>();
    ...
    const releaseDate = parseDate(watch('Release_Date'));
    const premiereDate = parseDate(watch('Premiere_Date'));
    const endDate = parseDate(watch('End_Date'));
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 overflow-visible">
                ...
                <motion.div
                    variants={formItemVariants}
                    custom={1}
                    className="col-span-1 relative group overflow-visible"
                >
                        ...
                        render={({ field }) => (
                            <div className="relative">
                                ...
                                <DatePicker
                                    ...
                                    className={`w-full pl-10 pr-4 py-3 bg-slate-700 text-white rounded-lg border ${errors.Release_Date ? 'border-red-500' : 'border-[#FFD875]/30'
                                    ...
                                    minDate={tomorrow} // Cho phép chọn từ ngày mai trở đi
                    ...
                    {releaseDate && (
                        <div className="mt-2 text-xs text-gray-300 flex items-center">
                            <span className="bg-[#FFD875]/10 text-[#FFD875] px-2 py-0.5 rounded font-medium mr-1">{format(releaseDate, 'EEEE', { locale: vi })}</span>
                ...
                >
                        ...
                        render={({ field }) => (
                            <div className="relative">
                                ...
                                <DatePicker
                                    ...
                                    className={`w-full pl-10 pr-4 py-3 bg-slate-700 text-white rounded-lg border ${errors.Premiere_Date ? 'border-red-500' : 'border-[#FFD875]/30'
                                        } focus:border-[#FFD875] focus:ring focus:ring-[#FFD875]/20 focus:outline-none transition-all duration-300 cursor-pointer shadow-[0_0_10px_0_rgba(255,216,117,0.3)] hover:shadow-[0_0_15px_0_rgba(255,216,117,0.5)]`}
                                    minDate={releaseDate ? new Date(Math.max(
                                        tomorrow.getTime(),
                                        releaseDate.getTime() + 24 * 60 * 60 * 1000 // +1 ngày từ Release_Date
                                    )) : tomorrow} // Phải sau ngày khởi chiếu hoặc từ ngày mai
                                    onFocus={e => e.target.blur()} // Ngăn không cho nhập trực tiếp
                                    popperPlacement="bottom"
                                    peekNextMonth
                                    showMonthDropdown
                    ...
                    {premiereDate && (
                        <div className="mt-2 text-xs text-gray-300 flex items-center">
                            <span className="bg-[#FFD875]/10 text-[#FFD875] px-2 py-0.5 rounded font-medium mr-1">{format(premiereDate, 'EEEE', { locale: vi })}</span>
                ...
                >
                        ...
                        render={({ field }) => (
                            <div className="relative">
                                ...
                                <DatePicker
                                    ...
                                    className={`w-full pl-10 pr-4 py-3 bg-slate-700 text-white rounded-lg border ${errors.End_Date ? 'border-red-500' : 'border-[#FFD875]/30'
                                        } focus:border-[#FFD875] focus:ring focus:ring-[#FFD875]/20 focus:outline-none transition-all duration-300 cursor-pointer shadow-[0_0_10px_0_rgba(255,216,117,0.3)] hover:shadow-[0_0_15px_0_rgba(255,216,117,0.5)]`}
                                    minDate={(() => {
                                        if (premiereDate) {
                    ...
                    {endDate && (
                        <div className="mt-2 text-xs text-gray-300 flex items-center">
                            <span className="bg-[#FFD875]/10 text-[#FFD875] px-2 py-0.5 rounded font-medium mr-1">{format(endDate, 'EEEE', { locale: vi })}</span>
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <select
                                    id="Language"
                                    {...field}
                                    className={`w-full pl-10 pr-4 py-3 bg-slate-700 text-white rounded-lg border ${errors.Language ? 'border-red-500' : 'border-slate-500'
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <select
                                    id="Country"
                                    {...field}
                                    className={`w-full pl-10 pr-4 py-3 bg-slate-700 text-white rounded-lg border ${errors.Country ? 'border-red-500' : 'border-slate-500'
                                        } focus:border-[#FFD875] focus:ring focus:ring-[#FFD875]/20 focus:outline-none transition-colors duration-300 appearance-none shadow-[0_0_8px_0px_rgba(255,216,117,0.2)] group-hover:shadow-[0_0_15px_0px_rgba(255,216,117,0.4)]`}
                                >
