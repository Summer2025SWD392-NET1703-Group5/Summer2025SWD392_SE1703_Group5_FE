        ...
        <div className="space-y-4">
            ...
            {configMode ? (
                ...
                <>
                    ...
                    {!readOnly && (
                        <motion.div
                            className="bg-slate-800 rounded-lg p-4 flex flex-wrap gap-2 items-center border border-slate-700 shadow-lg"
                            initial={{ opacity: 0, y: -20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.3 }}
                        >
                            <span className="text-sm text-gray-300 mr-2">Chọn loại ghế:</span>

                            <button
                                onClick={() => setCurrentSeatType('Regular')}
                                className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 ${currentSeatType === 'Regular'
                                    ? 'bg-green-500 text-white shadow-[0_0_10px_0_rgba(34,197,94,0.4)]'
                                    : 'bg-slate-700 text-gray-300 hover:bg-slate-600'
                                    }`}
                            >
                                <span className="material-symbols-outlined text-[18px] mr-1 align-middle">weekend</span>
                                Ghế thường
                            </button>

                            <button
                                onClick={() => setCurrentSeatType('VIP')}
                                className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 ${currentSeatType === 'VIP'
                                    ? 'bg-purple-600 text-white shadow-[0_0_10px_0_rgba(139,92,246,0.4)]'
                                    : 'bg-slate-700 text-gray-300 hover:bg-slate-600'
                                    }`}
                            >
                                <span className="material-symbols-outlined text-[18px] mr-1 align-middle">weekend</span>
                            ...
                            <button
                                onClick={() => setCurrentSeatType('Couple')}
                                className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 ${currentSeatType === 'Couple'
                                    ? 'bg-pink-500 text-white shadow-[0_0_10px_0_rgba(236,72,153,0.4)]'
                                    : 'bg-slate-700 text-gray-300 hover:bg-slate-600'
                                    }`}
                            >
                                <span className="material-symbols-outlined text-[18px] mr-1 align-middle">weekend</span>
                            ...
                            <div className="ml-auto flex gap-2">
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg font-medium flex items-center gap-2 transition-all duration-300 ${selectedSeats.length > 0
                                        ? 'bg-[#FFD875] text-black hover:bg-[#e5c368] shadow-[0_0_15px_0_rgba(255,216,117,0.3)] hover:shadow-[0_0_20px_0_rgba(255,216,117,0.5)]'
                                        : 'bg-slate-700 text-gray-500 cursor-not-allowed'
                                        }`}
                                >
                                    <CheckIcon className="w-4 h-4" />
                                    Áp dụng ({selectedSeats.length})
                                </button>
                                ...
                                <button
                                    ...
                                    disabled={selectedSeats.length === 0}
                                    className={`px-4 py-2 rounded-lg font-medium flex items-center gap-2 transition-all duration-300 ${selectedSeats.length > 0
                                        ? 'bg-red-500 text-white hover:bg-red-600 shadow-[0_0_15px_0_rgba(239,68,68,0.3)] hover:shadow-[0_0_20px_0_rgba(239,68,68,0.5)]'
                                        : 'bg-slate-700 text-gray-500 cursor-not-allowed'
                                        }`}
                                >
                                    <TrashIcon className="w-4 h-4" />
                                    Xóa ({selectedSeats.length})
                                </button>

                                <button
                                    onClick={() => setConfigMode(true)}
                                    className="px-4 py-2 rounded-lg bg-blue-500 text-white hover:bg-blue-600 font-medium transition-all duration-300 flex items-center gap-2 shadow-[0_0_15px_0_rgba(59,130,246,0.3)] hover:shadow-[0_0_20px_0_rgba(59,130,246,0.5)]"
                                >
