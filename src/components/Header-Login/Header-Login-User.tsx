    ...
    <header className="header-login-user">
      ...
      <div className="header-login-user__right">
        ...
        <div className="header-login-user__profile-wrapper" ref={dropdownRef}>
          <button className="header-login-user__profile-btn" onClick={handleProfileClick}>
          ...
          {showDropdown && (
            <div className="header-login-user__profile-dropdown">
              <div className="header-login-user__profile-greeting">Chào,<br /><b>{user}</b></div>
              <ul>
                <li><span>❤️</span> Yêu thích</li>
                <li><span>➕</span> Danh sách</li>
                <li><span>⏩</span> Xem tiếp</li>
                <li><span>👤</span> Tài khoản</li>
                <li onClick={handleLogout} style={{ cursor: 'pointer', color: '#ff5252' }}><span>↩️</span> Thoát</li>
              </ul>
            </div>
          )}
        </div>
