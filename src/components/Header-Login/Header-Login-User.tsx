...
const HeaderLoginUser: React.FC = () => {
  ...
  return (
    <>
      ...
      <header ref={headerRef} className={`header-login-user ${isSticky ? "sticky-active" : ""}`}>
        <div className="header-login-user__logo" onClick={goToHome} style={{ cursor: "pointer" }}>
        ...
        <div className="header-login-user__right">
          ...
          <div className="header-login-user__profile-wrapper" ref={dropdownRef}>
            <button className="header-login-user__profile-btn" onClick={handleProfileClick}>
              ...
              <span className="header-login-user__profile-badge">Customer</span>
